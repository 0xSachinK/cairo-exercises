# Exercise 3: https://www.cairo-lang.org/docs/hello_cairo/puzzle.html#id1
# Modify verify_location_list so that it checks that the last location is indeed (3, 3).
...
func main():
    ...
    local loc_tuple : (
        ...
        # should fail.
        # An ASSERT_EQ instruction failed: 2 != 3.
        #   assert row = 3
        #   ^************^
